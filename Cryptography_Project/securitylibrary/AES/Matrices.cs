...
namespace SecurityLibrary.AES
{
    internal class Matrices
    {
        ...
        {
            return (i <= 58 && i >= 48) ? i - 48 : (i <= 102 && i >= 97) ? i - 87 : (i <= 70 && i >= 65) ? i - 55 : -1;
        }
        ...
        static public string ReplaceFromReversedSBox(string s)
        {
            for (int i = 0; i < SBox.GetLength(0); i++)
            {
                ...
                {
                    if (s == SBox[i, j].ToString("X")) return IntToString(i, j);
                }
            }
            return "";
        }
        ...
        private static string BinaryMultiplication(string a, string b)
        {
            ...
            {
                result = (b[i] == '1') ? (result == "") ? a : XOR(result, a + zeros) : XOR(result, "0");
                zeros += '0';
            }
        ...
        static private string Mult(int a, int b)
        {
            ...
            else
            {
                ...
                do
                {
                    answer = (answer != "") ? Convert.ToString(Convert.ToInt32(answer, 2), 2) : answer;
